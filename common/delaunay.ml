...
let animated_morphprint () =

  let rset1 = rand_m_points 100 800. 600. in
  let rset2 = delta_set rset1 50. 800. 600. in

  let f t = delaunay_morph_set rset1 rset2 t 800. 600. in
